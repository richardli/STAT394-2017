...
\frame{
  \frametitle{Also last Friday}
  Randomly draw 2 cards from the deck, if you know you have an Ace in the two cards, what is the probability that both cards are Aces? If you know you have an Ace of heart, what is the probability that both cards are Aces? 
  \vspace{5cm}
}
\frame{
  \frametitle{Review: Mutual Independence}
}
\frame{
